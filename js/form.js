import {MIN_TITLE_LENGTH, MAX_TITLE_LENGTH, MIN_PRICE_VALUE, MAX_PRICE_VALUE, MIN_STRING_TEXT, MAX_STRING_TEXT, MIN_NUMBER_TEXT, MAX_NUMBER_TEXT, ROOM_CAPACITY_TEXT, MAX_PHOTO_COUNT, typeMinPrice} from './constants.js';
...
const resetAvatar = () => {
  ...
  headerPreview.alt = 'Аватар пользователя';
  headerPreview.width = '40';
  headerPreview.height = '44';
};
